import { Package, Key, Smartphone, PawPrint, FileText, Settings } from 'lucide-react';
...
const categoryConfig = {
    ...
    electronics: { icon: Smartphone, label: 'อิเล็กทรอนิกส์', sublabel: 'Electronics', color: 'from-emerald-500 to-emerald-600', count: '892 รายการ' },
    pets: { icon: PawPrint, label: 'สัตว์เลี้ยง', sublabel: 'Pets', color: 'from-pink-500 to-pink-600', count: '345 รายการ' },
    documents: { icon: FileText, label: 'ของสะสม', sublabel: 'Documents', color: 'from-purple-500 to-purple-600', count: '678 รายการ' },
    settings: { icon: Settings, label: 'การตั้งค่า', sublabel: 'Settings', color: 'from-gray-500 to-gray-600', count: '123 รายการ' },
};
